      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:items-end">
          ...
          <motion.div
            ...
            className="lg:col-span-5 flex justify-center lg:justify-start lg:-ml-28 self-end z-10"
          >
            <div className="relative w-full max-w-[480px] lg:max-w-[540px] flex items-end justify-center">
              ...
              <Image 
                ...
                alt="Teacher Model" 
                priority
                className="w-full h-auto object-contain select-none pointer-events-none drop-shadow-[0_10px_15px_rgba(0,0,0,0.15)] drop-shadow-[0_30px_60px_rgba(47,128,237,0.26)] filter dark:drop-shadow-[0_30px_60px_rgba(242,153,74,0.15)] transform hover:scale-[1.03] transition-transform duration-500 z-10 translate-y-1 block"
              />
